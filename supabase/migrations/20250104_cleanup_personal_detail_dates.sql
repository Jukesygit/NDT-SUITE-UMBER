...
-- This migration removes created_at and expiry_date from these fields
...
COMMENT ON TABLE employee_competencies IS 'Personal detail fields (DOB, email, phone, address) should not have expiry_date, issuing_body, or certification_id';
