...
export function DomeScanSection({
  ...
  const importAppendageValid =
    importBodyId === '' || dishedAppendages.some((a) => a.id === importBodyId);
  ...
  return (
    <SubSection
      title="Dome Scans"
      count={domeScanComposites.length}
      isOpen={isOpen}
      onToggle={onToggle}
    >
      <button
          ...
          <div className="vm-modal">
            ...
            <div className="vm-modal-body">
              <p style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.5)', margin: '0 0 10px' }}>
                Select a dome composite to import. You can adjust orientation after import using the
                3D gizmo or sidebar controls.
              </p>
              {cloudDomeCompositesLoading ? (
                <p
                  style={{
                ...
                cloudDomeComposites.map((c) => (
                  <div
                    ...
                    onClick={() => {
                      setImportingId(c.id);
                      if (c.section_type === 'dome_left') {
                        setImportHead('left');
                        setImportBodyId('');
                      } else if (c.section_type === 'dome_right') {
                        setImportHead('right');
                        setImportBodyId('');
                  ...
                  >
                    <div className="vm-list-item-info">
                      ...
                      >
                        ...
                        {c.section_type && (
                          <> &middot; {sectionLabel(c.section_type)}</>
...
function DomeScanEditPanel({
  ...
  return (
    ...
    >
        ...
        <div className="vm-control-group">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              if (v === '')
                onUpdate({ bodyId: undefined, head: ds.head === 'end' ? 'right' : ds.head });
      ...
      {ds.orientationConfirmed && (
        <div
          style={{ borderTop: '1px solid rgba(255,255,255,0.08)', marginTop: 10, paddingTop: 10 }}
        >
          <div className="vm-control-group">
            <div className="vm-label">
