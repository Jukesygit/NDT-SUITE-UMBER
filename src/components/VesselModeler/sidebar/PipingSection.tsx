...
function segmentLabel(seg: PipeSegment): string {
  switch (seg.type) {
    ...
    case 'dome':
      return `Dome End ${Number((seg.headRatio ?? 2).toFixed(1))}:1`;
    default:
      return seg.type;
  }
}
...
export function PipingSection({
  ...
  const selectedSegment =
    selectedPipeline && selectedSegmentIdx >= 0
                    ...
                    >
                      <div className="vm-control-group">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            onUpdateNozzle(selectedNozzleIndex, { name: e.target.value })
                          }
                        />
                      </div>
                        ...
                        <div className="vm-toggle-group">
                          {(
                            ...
                            <button
                              ...
                              onClick={() =>
                                onUpdateNozzle(selectedNozzleIndex, { orientationMode: mode })
                              }
                              title={
                                mode === 'radial'
                        ...
                        <button
                          ...
                          onClick={() =>
                            onUpdateNozzle(selectedNozzleIndex, {
                              azimuthRotation: ((selectedNozzle.azimuthRotation ?? 0) + 90) % 360,
                            })
                          }
                  ...
                  {pl && (
                    <>
                      {pl.segments.map((seg, si) => {
                        const isSegSelected =
                          pl.id === selectedPipelineId && si === selectedSegmentIdx;
                        return (
                              ...
                              >
                                ...
                                {seg.type === 'elbow' && (
                                  <>
                                    ...
                                    <SliderRow
                                      ...
                                      unit="mm"
                                      onChange={(v) =>
                                        onUpdateSegment(pl.id, seg.id, { bendRadius: v })
                                      }
                                    />
                                  </>
                                )}
                                {seg.type === 'reducer' && (
                                  <>
                                    <SliderRow
                                      ...
                                      unit="mm"
                                      onChange={(v) =>
                                        onUpdateSegment(pl.id, seg.id, { length: v })
                                      }
                                    />
                                    <SliderRow
                                      label="End Diameter"
                                      ...
                                      unit="mm"
                                      onChange={(v) =>
                                        onUpdateSegment(pl.id, seg.id, { endDiameter: v })
                                      }
                                    />
                                  </>
                                )}
                                ...
                                {seg.type === 'dome' && (
                                  <SliderRow
                                    ...
                                    unit=":1"
                                    onChange={(v) =>
                                      onUpdateSegment(pl.id, seg.id, { headRatio: v })
                                    }
                                  />
                                )}
                              </div>
                            ...
                            {seg.type === 'elbow' && (
                              <>
                                ...
                                <SliderRow
                                  ...
                                  unit="mm"
                                  onChange={(v) =>
                                    onUpdateSegment(fp.id, seg.id, { bendRadius: v })
                                  }
                                />
                              </>
                            )}
                            {seg.type === 'reducer' && (
                              <>
                                ...
                                <SliderRow
                                  ...
                                  unit="mm"
                                  onChange={(v) =>
                                    onUpdateSegment(fp.id, seg.id, { endDiameter: v })
                                  }
                                />
                              </>
                            )}
