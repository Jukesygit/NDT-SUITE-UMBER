            ...
            <div className="dc-chassis">
                <div className="dc-panel">
                    ...
                    <div className="dc-main-layout">
                        ...
                        <div className="dc-groove-vertical" />
                    ...
                    {/* Nameplate strip */}
                    <div className="dc-nameplate-bar">
                        <span className="dc-nameplate">Matrix Portal</span>
                        <span className="dc-nameplate-model">Document Control System</span>
                    </div>
                </div>
            </div>
...
function DocumentSidebar() {
    ...
    return (
        <div className="dc-sidebar">
            ...
            {categories.length > 0 && (
                <>
                    {attentionItems.length > 0 && <div className="dc-groove" />}
                    <div className="dc-sidebar-zone">
            ...
            {recentDocs.length > 0 && (
                <>
                    {(attentionItems.length > 0 || categories.length > 0) && <div className="dc-groove" />}
                    <div className="dc-sidebar-zone">
