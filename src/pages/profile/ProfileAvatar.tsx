 ...
 *
 * `avatarUrl` arrives already-resolved and displayable (see
 * hooks/queries/useAvatarUrls); this component never touches storage. A URL that
 * resolves and then fails to load (expired signature, deleted object, a legacy
 * public URL after the bucket flip) falls back to the placeholder icon instead
    ...
    <div className="pf-avatar-section">
      <div className="pf-avatar-wrapper">
        <div className="pf-avatar-circle">
          {displayUrl ? (
            <img src={displayUrl} alt="Profile" onError={() => setFailedUrl(avatarUrl ?? null)} />
          ) : (
            <UserIcon />
          )}
        </div>
