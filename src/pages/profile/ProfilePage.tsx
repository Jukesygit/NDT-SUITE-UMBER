...
} from '../../hooks/queries/useCompetencies';
import {
  useUpdateProfile,
  useUploadAvatar,
  useCreateCompetency,
...
export default function ProfilePage() {
  ...
  const handleDisable2FA = async () => {
    ...
    try {
      ...
      ).twoFactorService.unenroll(twoFactorStatus.data.factorId);
      ...
      try {
        ...
        alert(
          err instanceof Error
            ? err.message
            : 'Session verification failed. Please sign out and sign in again.'
        );
        return;
      }
  ...
  const profileFormData: ProfileFormData = {
    ...
    next_of_kin_emergency_contact_number:
      profileQuery.data?.next_of_kin_emergency_contact_number || '',
    ...
    <div className="h-full overflow-y-auto" style={{ scrollbarGutter: 'stable' }}>
        ...
        <div className="pf-panel">
          ...
          <div className="pf-info-block">
            ...
            <p className="pf-info-text">
              Manage your personal data in accordance with UK GDPR. You can download a copy of all
              your data or permanently delete your account.
            </p>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <button className="pf-btn sm danger" onClick={() => setShowDeleteConfirm(true)}>
                Delete My Account
              </button>
              <a href="/privacy" className="pf-btn sm ghost">
                Privacy Policy
              </a>
            </div>
      ...
      >
        <div style={{ lineHeight: '1.6' }}>
          <p
            className="pf-info-text pf-status-danger"
            style={{ fontWeight: '600', marginBottom: '12px' }}
          >
            This action is permanent and cannot be undone.
          </p>
          <p className="pf-info-text" style={{ marginBottom: '10px' }}>
          ...
          >
            <li className="pf-info-text" style={{ margin: 0 }}>
              Remove your profile and all personal information
            </li>
            <li className="pf-info-text" style={{ margin: 0 }}>
              Delete all your competency records and certificates
            </li>
            <li className="pf-info-text" style={{ margin: 0 }}>
              Remove your uploaded documents
            </li>
            <li className="pf-info-text" style={{ margin: 0 }}>
              Anonymise your activity history (for audit compliance)
            </li>
          </ul>
          ...
          {deleteMyAccount.isError && (
            ...
            >
              {deleteMyAccount.error instanceof Error
                ? deleteMyAccount.error.message
      ...
      >
        ...
        >
          {((definitionsQuery.data as CompetencyDefinition[]) || [])
            .filter((def) => {
              const categoryName =
                typeof def.category === 'object' ? def.category?.name : def.category;
            ...
            .map((def) => (
              ...
              >
                <div>
                  ...
                  {def.description && <div className="pf-picker-desc">{def.description}</div>}
                </div>
                <svg
                  className="pf-picker-icon"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
