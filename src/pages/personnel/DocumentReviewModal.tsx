...
export function DocumentReviewModal({
  ...
  const modalContent = (
    <div className="pm-modal-overlay" style={{ animation: 'fadeIn 0.15s ease-out' }}>
      {/* Backdrop click area */}
      <div
        ...
        <div className="flex-1 overflow-hidden flex" style={{ minHeight: 0 }}>
          ...
          <div className="w-96 flex-shrink-0 overflow-y-auto flex flex-col">
            ...
            <div style={{ padding: '20px', borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
              ...
              {approval.issuing_body && (
                <DetailRow label="Issuing Body" value={approval.issuing_body} />
              )}
              {approval.certification_id && (
                <DetailRow label="Certification ID" value={approval.certification_id} />
              )}
