...
export function CertificateDetailModal({
  ...
  return (
    <Modal isOpen={!!competency} onClose={onClose} title={`${certName} - Details`} size="large">
      {/* Certificate Details */}
        ...
        <div className="pm-field-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
          {competency.level && (
            <div className="pm-display-field">
              ...
              <span className="pm-display-value" style={{ fontWeight: '600' }}>
                {competency.level}
              </span>
            </div>
          )}
      ...
      <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
        ...
        <button onClick={onClose} className="pm-btn primary sm">
          Close
        </button>
      </div>
    </Modal>
