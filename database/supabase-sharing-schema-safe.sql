...
DROP POLICY IF EXISTS "Users can view relevant shares" ON shared_assets;
DROP POLICY IF EXISTS "Only admins can create shares" ON shared_assets;
DROP POLICY IF EXISTS "Only admins can update shares" ON shared_assets;
DROP POLICY IF EXISTS "Only admins can delete shares" ON shared_assets;
