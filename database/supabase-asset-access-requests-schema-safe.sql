...
ALTER TABLE asset_access_requests DROP CONSTRAINT IF EXISTS unique_asset_access_request;

-- Add unique constraint
ALTER TABLE asset_access_requests
ADD CONSTRAINT unique_asset_access_request
...
DROP POLICY IF EXISTS "Users can view relevant asset access requests" ON asset_access_requests;
DROP POLICY IF EXISTS "Authenticated users can create asset access requests" ON asset_access_requests;
DROP POLICY IF EXISTS "Admins can update asset access requests" ON asset_access_requests;
